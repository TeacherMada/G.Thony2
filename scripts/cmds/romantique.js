...
async function a(api, event, args, message) {
  try {
    ...
    if (!a) {
      return message.reply("ex: #romantique salut\n \n ↪ Répondez mon message pour la conversation continue");
    }

    const b = "Ton nom est Romantique, tu es complètement amoureux(euse), utiliser les emoji amour tels que ♥🥰😘😍🎉"; // the more better content you give the  best it became
    const c = await d(a, b);
...
module.exports = {
  config: {
    name: "romantique",// add your ai name here
    version: "1.0",
    author: "tsanta",
    role: 0,
    longDescription: "Ai romantique",// ai description
    category: "ai",
    guide: {
